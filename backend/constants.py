FO_STOCKS = [
    ...
    "LUPIN","JUBLFOOD","MOTHERSON","CHOLAFIN","MUTHOOTFIN","UPL","POLYCAB",
    "SRF","DABUR","GODREJCP","INDUSTOWER","NAUKRI","BHARATFORG","COFORGE",
    "PETRONET","INDHOTEL","PAGEIND",
]
INDEX_SYMBOLS = ["NIFTY", "BANKNIFTY", "FINNIFTY", "MIDCPNIFTY", "SENSEX"]

LOT_SIZES = {
    "NIFTY": 75, "BANKNIFTY": 30, "FINNIFTY": 65, "MIDCPNIFTY": 120, "SENSEX": 10,
